# Example data: k = 11 groups, n = 10 per group
...
# Long-format data frame for kruskal.test
y <- c(g1, g2, g3, g4, g5, g6, g7, g8, g9, g10, g11)
g <- factor(rep(paste0("g", 1:11), each = 10), levels = paste0("g", 1:11))
df <- data.frame(y = y, g = g)

# Built-in Kruskal-Wallis test
res <- kruskal.test(y ~ g, data = df, )
print(res)